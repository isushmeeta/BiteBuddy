...
//     try {
//       if (editingItemId) {
//         await api.put(`/menu/${restaurantId}/item/${editingItemId}`, form);
//         setEditingItemId(null);
//       } else {
//         await api.post(`/menu/${restaurantId}/item`, form);
//       }
...
//     try {
//       await api.delete(`/menu/${restaurantId}/item/${itemId}`);
//       loadMenu();
//     } catch (err) {
...
//         <input name="name" placeholder="Name" value={form.name} onChange={handleChange} className="border p-2 m-1 w-full" />
//         <input name="price" placeholder="Price" type="number" value={form.price} onChange={handleChange} className="border p-2 m-1 w-full" />
//         <input name="description" placeholder="Description" value={form.description} onChange={handleChange} className="border p-2 m-1 w-full" />
//         <input name="image" placeholder="Image URL" value={form.image} onChange={handleChange} className="border p-2 m-1 w-full" />
